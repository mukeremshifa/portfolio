...
export function CertificationCard({
  ...
  return (
    <article className="group flex h-full flex-col gap-4 rounded-none border border-border-subtle bg-surface p-6 transition-[border-color,background-color,transform] duration-(--duration-base) ease-out hover:-translate-y-1 hover:border-border-strong hover:bg-surface-alt">
