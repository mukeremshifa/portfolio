...
const base =
  "inline-flex min-h-11 min-w-11 items-center justify-center gap-2 rounded-md font-sans font-medium transition-[background-color,border-color,color,transform] duration-(--duration-fast) ease-standard active:scale-[0.98]";
